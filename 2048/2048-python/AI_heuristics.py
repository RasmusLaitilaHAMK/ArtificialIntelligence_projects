...
def evaluate_board(board):
    ...
    score += LH.heuristic_PenalizeDistance(board) * 0.25  # had a negative effect on the score
    score += KH.heuristic_DynamicMergePriority(board, empty_threshold=5, tie_break="points") * 0.4 # Negative effect on the score
